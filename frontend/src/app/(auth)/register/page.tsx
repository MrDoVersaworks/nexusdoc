      ...
      <div className={styles.authCard}>
        ...
        <div className="flex items-center gap-3 p-4 mb-6 bg-accent-blue/5 border border-accent-blue/10 rounded-xl">
          <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-accent-blue/10 rounded-lg text-accent-blue">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="m8 3 4 8 5-5 5 15H2L8 3z"/></svg>
          </div>
          <div>
            <p className="text-xs font-bold text-accent-blue uppercase tracking-widest mb-1">Frictionless Client Demo</p>
            <p className="text-[10px] text-text-muted leading-relaxed">
              Email verification is temporarily disabled to allow immediate, seamless access. You may use any dummy email to proceed.
            </p>
          </div>
        </div>
        ...
        <form className={styles.authForm} onSubmit={handleSubmit} id="register-form">
          ...
          <div className={styles.authFormGroup}>
            ...
            <input id="register-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" required autoComplete="email" />
          </div>
...
aria-pressed={showConfirmPassword}
          ...
          <div className={styles.termsBox}>
            <label className={styles.termsLabel} htmlFor="terms-checkbox-nd">
              <input id="terms-checkbox-nd" type="checkbox" checked={termsAgreed} onChange={(e) => setTermsAgreed(e.target.checked)} />
              <span>
          ...
          <button type="submit" className={`btn btn-primary ${styles.authSubmitBtn}`} disabled={isSubmitting || !termsAgreed} id="register-submit">
