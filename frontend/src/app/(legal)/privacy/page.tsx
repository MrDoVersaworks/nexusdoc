        ...
        {loading ? (
          ...
          <div className="space-y-6">
            <section className="space-y-4">
              ...
              <p>When you use NexusDoc, we collect information you provide directly: your name, email address, and uploaded documents.</p>
            </section>
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">2. Data Security</h2>
              <p>All sensitive credentials are encrypted using AES-256-GCM before storage. Document embeddings are stored securely using pgvector.</p>
            </section>
          </div>
        )}
      </div>
